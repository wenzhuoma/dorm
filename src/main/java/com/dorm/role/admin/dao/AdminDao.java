package com.dorm.role.admin.dao;

import com.dorm.base.dao.BaseDao;
import com.dorm.role.admin.entity.Admin;
import com.dorm.role.admin.provider.AdminSqlProvider;
...
public interface AdminDao extends BaseDao<Admin> {
    ...
    @InsertProvider(type = AdminSqlProvider.class, method = "savePwd")
    public void savePwd(Admin admin);
